...
public class StudentExam1 {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		System.out.println(su1.toString()); // 해당 인스턴스에 대한 stack에 있는 heap의 위치를 16진수로 출력
		System.out.println(su1.equals(su2)); // 두 객체(인스턴스)가 같은 지 비교
		System.out.println(su1.hashCode()); // 해시코드 
		System.out.println(su1.equals(su3)); // su3과 su1의 주소가 서로 달라 false로 출력
		
		// Student 클래스에 equals를 모든 멤버 필드(뼌수)에 대하여 비교하는 오버라이딩을 해주면, 값 비교가 가능하다.
