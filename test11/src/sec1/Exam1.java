...
public class Exam1 {
	...
	public static void main(String[] args) {
		...
		String s1 = "장인범";	// 기본형X, 참조형X
		String s2 = "장인범";
		System.out.println("s1 == s2 : " + (s1==s2)); // 틀린 문자열의 값 비교
		System.out.println("s1 equals s2 : " + s1.equals(s2)); // 맞는 문자열의 값 비교 -> Sting 클래스 연산을 해야 하므로 반드시 equals 메소드를 써서 비교해야함
		
		Integer c = new Integer(1004);	// 참조형
		Integer d = new Integer(1004);	// 참조형
		
		System.out.println("a == c : " + (a==c)); // 기본형과 차몾형의 비교는 값 비교
